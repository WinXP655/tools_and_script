...
def first_check():
    if ping():
        ...
        acquiring_message = "Connected at: " + \
...
def main():
    ...
    monitoring_date_time = "Network monitoring started at: " + \
    ...
    while True:
        if ping():
            ...
            fail_msg = "Connection lost at: " + str(down_time).split(".")[0]
            print(fail_msg)
            with open(FILE, "a") as file:
                file.write(fail_msg + "\n")
            ...
            uptime_message = "Connection restored: " + str(up_time).split(".")[0]
            down_time = calculate_time(down_time, up_time)
            unavailablity_time = "Connection was not available for: " + down_time
